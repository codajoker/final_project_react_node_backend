...
const { joiSchemaRegistration, joiSchemaLogin } = require('../../service/shemas/shema');
...
route.post('/register', validationAuth(joiSchemaRegistration), ctrlWrapper(registerController));
route.post('/login', validationAuth(joiSchemaLogin),ctrlWrapper(loginController));
